...
== The output
image::rendered_pictures/float_depth100_sample100000_9.bmp[Rendered image, width=600]
float, depth100, sample100000. qhd.

The below are all float, depth100, sample500. qhd.
